...
Решение:
Docker Compose упрощает работу с приложениями из нескольких контейнеров. Вместо кучи сложных команд мы описываем всю систему в одном файле и запускаете её одной строкой.
